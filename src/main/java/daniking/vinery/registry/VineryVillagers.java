...
public class VineryVillagers {
    ...
    public static void init() {
        ...
        TradeOfferHelper.registerVillagerOffers(WINEMAKER, 2, factories -> {
            factories.add(new SellItemFactory(ObjectRegistry.KELP_CIDER, 1, 1, 10));
        ...
        TradeOfferHelper.registerVillagerOffers(WINEMAKER, 5, factories -> {
            ...
            factories.add(new SellItemFactory(ObjectRegistry.AEGIS_WINE, 5, 1, 10));
            factories.add(new SellItemFactory(ObjectRegistry.GLOVES, 5, 1, 10));
        });
